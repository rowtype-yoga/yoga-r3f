module Yoga.React.R3F.Hooks where
...
import Yoga.React.R3F.Three.Types (Object3D, Texture)
import Yoga.React.R3F.Three.Types as Three
...
foreign import useFrameImpl :: EffectFn1 (EffectFn2 { | RootState } Number Unit) Unit
foreign import useThreeImpl :: forall subset. EffectFn1 ({ | RootState } -> subset) subset
foreign import applyPropsImpl :: forall props. EffectFn2 JSX { | props } Unit
foreign import applyRefPropsImpl :: forall props. EffectFn2 (Ref JSX) { | props } Unit
foreign import applyScenePropsImpl :: forall props. EffectFn2 Three.Scene { | props } Unit
