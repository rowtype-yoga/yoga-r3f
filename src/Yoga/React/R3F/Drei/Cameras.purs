module Yoga.React.R3F.Drei.Cameras where

import React.Basic (JSX, ReactComponent, element)

perspectiveCamera :: forall props. { | props } -> JSX
perspectiveCamera = element perspectiveCameraImpl

orthographicCamera :: forall props. { | props } -> JSX
orthographicCamera = element orthographicCameraImpl
